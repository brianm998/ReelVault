...
- **Kotlin Compose डेस्कटॉप क्लाइंट** (`kotlin-desktop/`) — Compose Multiplatform UI। `127.0.0.1:50051` पर चल रहे डेमन को ऑटो-डिटेक्ट करता है; अगर कोई नहीं चल रहा तो बंडल्ड डेमन को खुद स्पॉन करता है (50051 बिज़ी होने पर OS-असाइन्ड पोर्ट पर फॉलबैक)।
