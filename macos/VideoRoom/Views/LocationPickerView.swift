...
struct LocationPickerView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Pan and zoom the map (trackpad pinch works too), then click where the video was captured — or click an existing pin to re-use that spot. The coordinate is saved to VideoRoom's catalog and (optionally) embedded into the video file.")
                .font(.caption)
