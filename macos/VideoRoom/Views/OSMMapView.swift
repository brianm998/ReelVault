...
private struct _OSMMapKitView: NSViewRepresentable {
    ...
    final class Coordinator: NSObject, MKMapViewDelegate {
        ...
        func mapView(_ mapView: MKMapView, viewFor annotation: any MKAnnotation) -> MKAnnotationView? {
            ...
            case .primary:
                let identifier = "videoroom.pin.primary"
                ...
                return view
            case .secondary:
                let identifier = "videoroom.pin.secondary"
                let view = (mapView.dequeueReusableAnnotationView(withIdentifier: identifier)
                            as? MKMarkerAnnotationView)
                    ?? MKMarkerAnnotationView(annotation: pin, reuseIdentifier: identifier)
                view.annotation = pin
                ...
                view.canShowCallout = true
                view.clusteringIdentifier = "videoroom.cluster.secondary"
                return view
            case .named:
                ...
                let identifier = "videoroom.pin.named"
                let view = (mapView.dequeueReusableAnnotationView(withIdentifier: identifier)
                            as? MKMarkerAnnotationView)
                    ?? MKMarkerAnnotationView(annotation: pin, reuseIdentifier: identifier)
                view.annotation = pin
...
/// `MKTileOverlay` subclass that fetches OSM tiles with VideoRoom's
