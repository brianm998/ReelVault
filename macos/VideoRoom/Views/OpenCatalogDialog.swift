...
struct OpenCatalogDialog: View {
    ...
    /// When `true`, the only "back-out" action is "Quit VideoRoom" — used at
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("A catalog is the SQLite file VideoRoom uses to remember your library — locations, tags, notes, thumbnails. Each catalog is independent.")
                .font(.caption)
            ...
            HStack(spacing: 8) {
                ...
                .help("Pick an existing .db file from disk. VideoRoom will mount it and load its library.")
            ...
            HStack {
                ...
                if isStartup {
                    ...
                    .help("Quit VideoRoom without opening a catalog.")
                } else {
