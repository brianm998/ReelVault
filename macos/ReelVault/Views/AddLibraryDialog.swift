...
struct AddLibraryDialog: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            .help("When on, ReelVault walks into every subdirectory. When off, only files directly inside the chosen folder are indexed.")
            ...
            .help("When on, ReelVault parses each video's filename for a date and uses it as the capture date if the file itself doesn't already have one. Useful for camera exports whose internal metadata lacks a capture time.")
            ...
            HStack {
                ...
                .help("Save these locations and start scanning. Indexing runs in the background — you can keep using ReelVault while it works.")
            }
        }
        .padding(20)
        .frame(width: 520)
