 ...
 * `~/.config/reelvault/recents.properties`. Entries are stored newest-first
...
class RecentCatalogs(
    ...
    private fun rewrite(items: List<String>) {
        ...
        try {
            ...
            configFile.outputStream().use { props.store(it, "ReelVault recent catalogs") }
    ...
    companion object {
        ...
        fun defaultConfigFile(): File {
            ...
            return File(File(home, ".config/reelvault"), "recents.properties")
        }
