...
//
// ReelVault is dark-mode only. A light theme was intentionally removed —
...
private val PurpleDarkColorScheme = darkColorScheme(
    primary = ReelVaultColors.PrimaryDark,
    onPrimary = Color(0xFF000000),
    primaryContainer = Color(0xFF3700B3),
    onPrimaryContainer = Color(0xFFEADDFF),

    secondary = ReelVaultColors.Secondary,
    onSecondary = Color(0xFF000000),
    secondaryContainer = Color(0xFF005048),
    onSecondaryContainer = Color(0xFFA0F2E8),

    tertiary = ReelVaultColors.Tertiary,
